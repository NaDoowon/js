		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공편 조회(B07)",
									"targetURL": "#examexprogramb07-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogramb07-display": {
								"semanticObject": "examexprogramb07",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogramb07",
									"url": sap.ui.require.toUrl("exam/exprogramb07")
								}
							}
						}
					}
