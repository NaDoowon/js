		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공편 조회",
									"targetURL": "#examexprogramb17-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogramb17-display": {
								"semanticObject": "examexprogramb17",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogramb17",
									"url": sap.ui.require.toUrl("exam/exprogramb17")
								}
							}
						}
					}
