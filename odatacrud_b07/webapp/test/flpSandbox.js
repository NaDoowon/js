		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#odatacrudb07-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odatacrudb07-display": {
								"semanticObject": "odatacrudb07",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odatacrudb07",
									"url": sap.ui.require.toUrl("odatacrudb07")
								}
							}
						}
					}
