		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calculation",
									"targetURL": "#practiceb0701-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"practiceb0701-display": {
								"semanticObject": "practiceb0701",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=practiceb0701",
									"url": sap.ui.require.toUrl("practiceb0701")
								}
							}
						}
					}
