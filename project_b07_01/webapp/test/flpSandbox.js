		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title1",
									"targetURL": "#projectb0701-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0701-display": {
								"semanticObject": "projectb0701",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0701",
									"url": sap.ui.require.toUrl("projectb0701")
								}
							}
						}
					}
