		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title3",
									"targetURL": "#projectb0703-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0703-display": {
								"semanticObject": "projectb0703",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0703",
									"url": sap.ui.require.toUrl("projectb0703")
								}
							}
						}
					}
