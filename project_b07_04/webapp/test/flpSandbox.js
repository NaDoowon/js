		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Json CRUD",
									"targetURL": "#projectb0704-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0704-display": {
								"semanticObject": "projectb0704",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0704",
									"url": sap.ui.require.toUrl("projectb0704")
								}
							}
						}
					}
