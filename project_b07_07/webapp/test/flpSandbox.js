		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chart",
									"targetURL": "#projectb0707-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0707-display": {
								"semanticObject": "projectb0707",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0707",
									"url": sap.ui.require.toUrl("projectb0707")
								}
							}
						}
					}
