		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX400 문제",
									"targetURL": "#sapbtpux400solvingb17-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux400solvingb17-display": {
								"semanticObject": "sapbtpux400solvingb17",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux400solvingb17",
									"url": sap.ui.require.toUrl("sap/btp/ux400solvingb17")
								}
							}
						}
					}
