		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410문제",
									"targetURL": "#sapbtpux410solvingb17-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux410solvingb17-display": {
								"semanticObject": "sapbtpux410solvingb17",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux410solvingb17",
									"url": sap.ui.require.toUrl("sap/btp/ux410solvingb17")
								}
							}
						}
					}
