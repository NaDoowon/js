		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SD] 판매오더 승인 프로그램",
									"targetURL": "#zbasalesorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbasalesorder-display": {
								"semanticObject": "zbasalesorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbasalesorder",
									"url": sap.ui.require.toUrl("zbasalesorder")
								}
							}
						}
					}
